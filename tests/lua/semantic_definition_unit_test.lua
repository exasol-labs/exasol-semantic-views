...
test("semantic preprocessor covers authoring discovery and explain commands", function()
    local commands = {
        ...
        {"SHOW SEMANTIC DIMENSIONS FOR METRIC sales.SALES.total_revenue", "OK", "SEMANTIC_CATALOG.METRIC_COMPATIBLE_DIMENSIONS mcd"},
        {"SHOW ALL SEMANTIC DIMENSIONS FOR METRIC sales.SALES.total_revenue", "OK", "SEMANTIC_CATALOG.METRIC_DIMENSION_COMPATIBILITY mcd"},
