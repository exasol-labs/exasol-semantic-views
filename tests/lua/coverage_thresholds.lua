...
-- fixed-length property tests.
return {
    lines = {
        ["lua/semantic_layer/shared/grain_graph.lua"] = 94.5,
        ...
        ["lua/semantic_layer/compiler/request_json.lua"] = 85.9,
        ["lua/semantic_layer/admin/validator.lua"] = 92.7,
