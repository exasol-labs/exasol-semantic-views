...
| Governance | `VALIDATION_RUNS`, `VALIDATION_RESULTS`, `METRIC_DIMENSION_MATRIX`, `MODEL_ROLE_GRANTS` |
| Operations and evolution | `QUERY_LOG`, `AGENT_REQUEST_LOG`, `AGENT_FEEDBACK`, `MODEL_EVOLUTION_SUGGESTIONS`, `MODEL_EVOLUTION_TARGETS`, `MODEL_EVOLUTION_REVIEWS` |
