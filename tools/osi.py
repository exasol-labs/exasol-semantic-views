...
def cleanup_imported_model(con: Any, model_name: str) -> None:
    ...
    queries = [
        ...
        f"DELETE FROM SYS_SEMANTIC.IDENTITY_MAPPING_RELATIONS WHERE {model_filter}",
        f"DELETE FROM SYS_SEMANTIC.IDENTITY_BINDINGS WHERE {model_filter}",
        f"DELETE FROM SYS_SEMANTIC.SEMANTIC_IDENTITIES WHERE {model_filter}",
        f"DELETE FROM SYS_SEMANTIC.ATTRIBUTE_FUSION_POLICIES WHERE {model_filter}",
        f"DELETE FROM SYS_SEMANTIC.ATTRIBUTE_BINDINGS WHERE {model_filter}",
        ...
        f"DELETE FROM SYS_SEMANTIC.REPRESENTATION_AUTHORITIES WHERE {model_filter}",
