...
def main() -> int:
    ...
    try:
        ...
        statements = [
            ...
            "EXECUTE SCRIPT SEMANTIC_ADMIN.ADD_ATTRIBUTE_BINDING('bug20_verify', 'DIMENSION', 'order_status', 'cold', 'o.order_status', 'PREFER', 1)",
            "EXECUTE SCRIPT SEMANTIC_ADMIN.ADD_ATTRIBUTE_BINDING('bug20_verify', 'FACT', 'amount', 'cold', 'o.amount', 'PREFER', 1)",
