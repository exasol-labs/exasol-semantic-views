...
def main() -> int:
    ...
    try:
        ...
        expected_counts = {
            ...
            # 4 in SALES + ship_mode and customer_segment in ORDER_HEADER.
            "SEMANTIC_CATALOG.DIMENSIONS WHERE MODEL_NAME = 'sales'": 6,
            "SEMANTIC_CATALOG.FACTS WHERE MODEL_NAME = 'sales'": 4,
            "SEMANTIC_CATALOG.METRICS WHERE MODEL_NAME = 'sales'": 6,
            "SEMANTIC_CATALOG.OBJECT_COLUMNS WHERE MODEL_NAME = 'sales' AND OBJECT_NAME = 'SALES' AND IS_VISIBLE = TRUE": 9,
            "SEMANTIC_CATALOG.OBJECT_COLUMNS WHERE MODEL_NAME = 'sales' AND OBJECT_NAME = 'ORDER_HEADER' AND IS_VISIBLE = TRUE": 3,
